...
import { G as GraduationCap, b as Stethoscope, c as Building2, d as Briefcase, e as Check, A as ArrowRight } from "../_libs/lucide-react.mjs";
...
function Membership() {
  const [tier, setTier] = reactExports.useState("Healthcare Professionals");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-5 lg:px-8 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: tiers.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-2xl border p-6 flex flex-col ${t.featured ? "bg-navy text-white border-emerald-brand shadow-2xl shadow-medical/20 lg:-translate-y-3" : "bg-card border-border"}`, children: [
