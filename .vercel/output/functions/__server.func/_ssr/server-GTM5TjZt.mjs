...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bg3apxSG.mjs");
...
const manifest = {
  "1c18681ad3dbd08beb1c534623f7bf75cc9344af3163addbff8b87ded1eb0835": {
    ...
    importer: () => import("./admin.functions-CvTnKiK2.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BrXL5jN2.mjs").then((n) => n.r),
    import("./start--RVMLhuK.mjs"),
