...
import { g as getEffectiveRole, b as isAdminRole, c as isPortalRole } from "./router-B9ucVT0q.mjs";
...
function Header() {
  ...
  reactExports.useEffect(() => {
    ...
    supabase.auth.getSession().then(({ data }) => syncAuth(data.session)).catch((error) => {
