...
import { a as ShieldCheck, L as LogIn } from "../_libs/lucide-react.mjs";
...
function AdminLogin() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-navy flex items-center justify-center p-6", children: [
