...
import { a as ShieldCheck, u as LogOut, B as BookOpen, C as Clock, l as CircleCheck, v as Bell, G as GraduationCap, w as User, x as Library, E as ExternalLink } from "../_libs/lucide-react.mjs";
...
function Portal() {
  ...
  const {
    ...
    queryKey: ["programs"],
    queryFn: async () => (await supabase.from("programs").select("id,title,slug,summary,duration,level,certification,price_usd").eq("is_published", true).order("created_at")).data ?? []
  });
  const {
    data: enrollments
  } = useQuery({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "hero-mesh text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 lg:px-8 py-12 flex flex-wrap items-center justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/admin", className: "inline-flex items-center gap-1.5 rounded-md bg-emerald-brand text-navy px-4 py-2.5 text-sm font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "size-4" }),
          "Admin"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: signOut, className: "inline-flex items-center gap-1.5 rounded-md bg-white/10 hover:bg-white/15 px-4 py-2.5 text-sm font-semibold border border-white/15", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-5", children: [
          ...
          !resources?.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Enroll in a program to access course materials added by your instructor." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-4 space-y-2 text-sm", children: resources.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-md border border-border p-3", children: [
            ...
            r.url && /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: r.url, target: "_blank", rel: "noopener noreferrer", className: "mt-1 inline-flex items-center gap-1 text-xs text-medical hover:underline", children: [
