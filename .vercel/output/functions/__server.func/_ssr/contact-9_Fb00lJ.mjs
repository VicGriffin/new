...
import { h as Mail, P as Phone, f as MapPin, i as Send } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-5 lg:px-8 py-20 grid lg:grid-cols-12 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 space-y-5", children: [
        [{
          ...
          icon: MapPin,
          l: "Office",
          v: "AMTMTI House, Westlands, Nairobi, Kenya"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 font-semibold text-navy", children: c.v })
          ] })
        ] }, c.l)),
