...
import { a as adminApproveEnrollment, b as adminRejectEnrollment, d as adminCompleteEnrollment, e as adminDeleteEnrollment, f as createSsrRpc } from "./enrollment.functions-BfPYweoP.mjs";
import { a as createServerFn } from "./index.mjs";
import { r as requireSupabaseAuth } from "./auth-middleware-DFQT01mP.mjs";
import { A as ALL_ROLES } from "./router-W4DiE8xe.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { a as adminCreateResource, b as adminDeleteResource } from "./resource.functions-76h2dUTp.mjs";
import "../_libs/seroval.mjs";
import { u as LogOut, D as LayoutDashboard, U as Users, B as BookOpen, G as GraduationCap, g as Mail, N as Newspaper, f as Calendar, M as Microscope, z as Library, I as Handshake, Q as Quote, p as Activity, J as Plus, k as CircleCheck, K as Pencil, O as Trash2 } from "../_libs/lucide-react.mjs";
...
const adminSetUserStatus = createServerFn({
  ...
  userId: stringType().uuid(),
  status: statusSchema
})).handler(createSsrRpc("4f5aa9f491ad26218a40bfe7686836429b3090c75cd44a37123635c11299c8d6"));
...
function UsersTab() {
  ...
  const updateStatus = useMutation({
    mutationFn: async ({ userId, status }) => {
      await adminSetUserStatus({ data: { userId, status } });
    },
    onSuccess: () => {
      ...
      users?.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-card p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `text-[9px] uppercase font-bold px-2 py-0.5 rounded ${u.status === "approved" ? "bg-emerald-brand/15 text-emerald-brand" : u.status === "pending" ? "bg-amber-100 text-amber-800" : "bg-red-100 text-red-800"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 items-center", children: [
            u.status !== "approved" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
function ProgramsTab() {
  ...
  const { data: categories } = useQuery({
    ...
    queryFn: async () => (await supabase.from("program_categories").select("id, name").order("name")).data ?? []
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    CrudLayout,
    {
      ...
      form: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, title: e.target.value }) : setForm({ ...form, title: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, slug: e.target.value }) : setForm({ ...form, slug: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, category_id: e.target.value }) : setForm({ ...form, category_id: e.target.value }),
            className: inp,
            children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, duration: e.target.value }) : setForm({ ...form, duration: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, level: e.target.value }) : setForm({ ...form, level: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, mode: e.target.value }) : setForm({ ...form, mode: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, certification: e.target.value }) : setForm({ ...form, certification: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, price_ksh: Number(e.target.value) }) : setForm({ ...form, price_ksh: Number(e.target.value) }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, cover_url: e.target.value }) : setForm({ ...form, cover_url: e.target.value }),
            className: inp
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, summary: e.target.value }) : setForm({ ...form, summary: e.target.value }),
            className: inp,
            rows: 2
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, description: e.target.value }) : setForm({ ...form, description: e.target.value }),
            className: inp,
            rows: 3
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, learning_outcomes: e.target.value }) : setForm({ ...form, learning_outcomes: e.target.value }),
            className: inp,
            rows: 2
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, requirements: e.target.value }) : setForm({ ...form, requirements: e.target.value }),
            className: inp,
            rows: 2
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            onChange: (e) => editId ? setEdit({ ...edit, curriculum: e.target.value }) : setForm({ ...form, curriculum: e.target.value }),
            className: inp,
            rows: 3
          }
        )
      ...
      onSubmit: (e) => {
        e.preventDefault();
        const activeForm = editId ? edit : form;
        let curriculum = null;
              ...
              RowActions,
              {
                onEdit: () => {
                  ...
                  setEdit({
                    ...
                    price_ksh: p.price_ksh ?? 0,
                    cover_url: p.cover_url ?? "",
                    apply_link: p.apply_link ?? "",
                    learning_outcomes: Array.isArray(p.learning_outcomes) ? p.learning_outcomes.join("\n") : "",
...
function NewsTab() {
  ...
  const [form, setForm] = reactExports.useState({ title: "", slug: "", excerpt: "", body: "", cover_url: "" });
  const [editId, setEditId] = reactExports.useState(null);
  const [edit, setEdit] = reactExports.useState(form);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    CrudLayout,
...
function ResearchTab() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data: data2, error } = await supabase.from("research_articles").select("*").order("created_at", { ascending: false });
      if (error) throw error;
      return data2 ?? [];
    }
  });
  ...
  const generatePDFUrl = async (pdfPath) => {
    try {
      const { data: data2, error } = await supabase.storage.from("research_files").createSignedUrl(pdfPath, 120);
      if (error) throw error;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    CrudLayout,
    {
      ...
      form: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-semibold text-navy block mt-1", children: "PDF File upload" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "file",
      ...
      onSubmit: async (e) => {
        ...
        try {
          ...
          if (selectedFile) {
            ...
            const { error: uploadError } = await supabase.storage.from("research_files").upload(fileName, selectedFile);
      ...
      list: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { message: "Loading…" }) : data?.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(ListRow, { title: a.title, sub: a.area ?? "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        a.pdf_path && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(RowActions, { onDelete: () => remove.mutate(a.id) })
      ] }) }, a.id))
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    CrudLayout,
    {
      ...
      form: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        form.kind === "document" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm text-muted-foreground", children: "Upload document" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "file",
          ...
          selectedFile && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground", children: [
            "Selected: ",
            selectedFile.name
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      list: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { message: "Loading…" }) : data?.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: r.title,
          sub: `${r.programs?.title ?? "General"} · ${r.kind}${r.kind === "document" ? ` · ${r.file_name ?? "Uploaded document"}` : ""}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(RowActions, { onDelete: () => deleteResource.mutate(r.id) })
        },
        r.id
      ))
    }
...
function EnrollmentsTab() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data: data2, error } = await supabase.from("course_enrollments").select("*, programs(title), profiles(full_name), payments(*)").order("enrolled_at", { ascending: false });
      if (error) throw error;
      return data2 ?? [];
    }
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { message: "Loading enrollments…" }),
    data?.map((e) => {
      const linkedPayment = e.payments?.[0];
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border bg-card p-5 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between items-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-navy", children: e.programs?.title || "Unknown Program" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-0.5", children: [
            "Student:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-navy", children: e.profiles?.full_name || "Guest User" }),
            " ",
            "· Progress: ",
            e.progress,
            "% · Status: ",
          ...
          linkedPayment && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-xs bg-muted px-2.5 py-1.5 rounded inline-flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-navy", children: "Payment Details:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Method: ",
              linkedPayment.payment_method
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Reference: ",
              linkedPayment.transaction_reference
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Amount: KSH ",
              Number(linkedPayment.amount).toLocaleString()
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
          e.status !== "active" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
          ...
          e.status !== "rejected" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
          ...
          e.status !== "completed" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    !isLoading && !data?.length && /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { message: "No enrollments found." })
  ] });
}
function CrudLayout({
  title,
...
function Admin() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "hero-mesh text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 lg:px-8 py-10 flex flex-wrap items-center justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: signOut, className: "inline-flex items-center gap-1.5 rounded-md bg-emerald-brand text-navy px-4 py-2.5 text-sm font-semibold", children: [
