...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-60yoLMe6.mjs");
...
const manifest = {
  "1c18681ad3dbd08beb1c534623f7bf75cc9344af3163addbff8b87ded1eb0835": {
    ...
    importer: () => import("./admin.functions-DjLdMUc7.mjs")
  },
  "21d9ea8ebece835665a682ef3fa77332d26144ad2410924b813f0273471b72d3": {
    functionName: "adminRejectEnrollment_createServerFn_handler",
    importer: () => import("./enrollment.functions-Bbd-UG7Y.mjs")
  },
  "358afa07b7b93837cfced7f848ad027b42a5acb50a738bc5a696c4922696c192": {
    functionName: "adminCreateResource_createServerFn_handler",
    importer: () => import("./resource.functions-CBz_12a0.mjs")
  },
  "4cee8d10f01379b0cb57bea35baed1d4467d322cd34b26bafca71d15f76850e9": {
    functionName: "createEnrollment_createServerFn_handler",
    importer: () => import("./enrollment.functions-Bbd-UG7Y.mjs")
  },
  "4f5aa9f491ad26218a40bfe7686836429b3090c75cd44a37123635c11299c8d6": {
  ...
  "6ad3b58c21d953e66e41e3552eddcee7163992c54d762c8200e0554e87000497": {
    functionName: "adminCompleteEnrollment_createServerFn_handler",
    importer: () => import("./enrollment.functions-Bbd-UG7Y.mjs")
  },
  "756b70ef45ca15008576333c1061e06638fabe52907b60a490077cd337e73a44": {
    functionName: "updateProgress_createServerFn_handler",
    importer: () => import("./enrollment.functions-Bbd-UG7Y.mjs")
  },
  "7fe60e17dc91a78cb0de49293d1c75f9b01786e4cd570c84f3b62cb6790e88c3": {
    functionName: "adminApproveEnrollment_createServerFn_handler",
    importer: () => import("./enrollment.functions-Bbd-UG7Y.mjs")
  },
  "96c132fdc9dc350b6b3a041609b90fb7a9ef984fe0aee08c0e737b8eca862fbe": {
    functionName: "adminDeleteEnrollment_createServerFn_handler",
    importer: () => import("./enrollment.functions-Bbd-UG7Y.mjs")
  },
  ...
  "b597591822fb604df0792c0b5591a0600e82e58ffd84f24e7750bb8db23e3007": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-W4DiE8xe.mjs").then((n) => n.r),
    import("./start-BdUPslnE.mjs"),
