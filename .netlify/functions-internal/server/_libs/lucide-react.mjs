...
const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$M);
const __iconNode$L = [
...
const CirclePlay = createLucideIcon("circle-play", __iconNode$D);
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$s);
const __iconNode$r = [
  [
    "path",
    {
...
const Library = createLucideIcon("library", __iconNode$p);
const __iconNode$o = [
...
const ListChecks = createLucideIcon("list-checks", __iconNode$o);
const __iconNode$n = [
...
const Pill = createLucideIcon("pill", __iconNode$d);
const __iconNode$c = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
